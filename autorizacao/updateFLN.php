...
if($retorno[0]){
    ...
    if (!$retAuto[0]) { 
        ...
        error_log(utf8_decode("[".date("Y-m-d H:i:s")."] Autorização com dados inválidos (Confira CMC e senha PMF). Token de acesso rejeitado. Emitente=".$autorizacao->idEmitente." Err=".$retAuto[1]."\n"), 3, "../arquivosNFSe/apiErrors.log");
        exit;
    }
    else {
