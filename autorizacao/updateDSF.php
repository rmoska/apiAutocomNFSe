...
//            }
    ...
    if ($configAcesso->idConfig > 0) {
        ...
        echo json_encode(array("http_code" => "401", "message" => "Não foi possível gerar Nota Fiscal. Configurações do servidor não definidas. Município = ".$emitente->codigoMunicipio." id=".$configAcesso->idConfig));
